...
internal class SHA512_224 : Digest<SHA512_224> {
    ...
    private var hashObject: CC_SHA512_CTX = nativeHeap.alloc<CC_SHA512_CTX>().also {
        ...
        it.hash[0] = 0x8C3D37C819544DA2UL
        it.hash[1] = 0x73E1996689DCD4D6UL
        it.hash[2] = 0x1DFAB7AE32FF9C82UL
        it.hash[3] = 0x679DD514582F9FCFUL
        it.hash[4] = 0x0F6D2B697BD44DA8UL
        it.hash[5] = 0x77E36F7304C48942UL
        it.hash[6] = 0x3F9D85A86A1D36C8UL
        it.hash[7] = 0x1112E6AD91D692A1UL
    ...
    override fun reset() {
        ...
        hashObject.hash[0] = 0x8C3D37C819544DA2UL
        hashObject.hash[1] = 0x73E1996689DCD4D6UL
        hashObject.hash[2] = 0x1DFAB7AE32FF9C82UL
        hashObject.hash[3] = 0x679DD514582F9FCFUL
        hashObject.hash[4] = 0x0F6D2B697BD44DA8UL
        hashObject.hash[5] = 0x77E36F7304C48942UL
        hashObject.hash[6] = 0x3F9D85A86A1D36C8UL
        hashObject.hash[7] = 0x1112E6AD91D692A1UL
