...
abstract class MD2Test {
    ...
    fun testMD2() {
        ...
        testKat({ digest() }, "message digest", "ab4f496bfb2a530b219ff33031fe06b0")
        testKat({ digest() }, "abcdefghijklmnopqrstuvwxyz", "4e8ddff3650292ab5a4108c3aa47940b")
        testKat({ digest() }, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", "da33def2a42df13975352846c30338cd")
        testKat(
            { digest() },
