...
internal abstract class CityHashTest {
    ...
    fun baseTest() {
        for (i in 0 until kTestSize - 1) {
            ...
            baseTest(testData[i], data)
        }

        baseTest(testData[kTestSize - 1], data)
    }

    abstract fun baseTest(expected: Expected, bytes: ByteArray)
    ...
    companion object {
        ...
        private const val kTestSize: Int = 300
