...
class RadioGatun32CoreTest : RadioGatun32Test() {
    override fun digest(): Digest<*> = CoreDigest.create(Algorithm.RadioGatun32)
...
class RadioGatun32InstalledProviderTest {
    ...
    fun noImplementation() {
        assertNull(PlatformDigest().create(Algorithm.RadioGatun32))
    }
}

/**
 * Test RadioGatún[32] implementation.
 */
abstract class RadioGatun32Test {
    ...
    @Test
    fun testRadioGatun32() {
        testKat(digest(), "", "F30028B54AFAB6B3E55355D277711109A19BEDA7091067E9A492FB5ED9F20117")
        testKat(digest(), "0", "AF0D3F51B98E90EEEBAE86DD0B304A4003AC5F755FA2CAC2B6866A0A91C5C752")
        testKat(digest(), "1", "896C580EF77A68C36B040DCD5A650C09B8B5D915ECE298AD0210A21ED5811C95")
        testKat(digest(), "2", "070182313AB302CFC82459786F4A30EC66260C6676495CE86E72B3BE7C60F7AD")
        testKat(digest(), "3", "E1D20A1B67028A7C102CF77B444E0F4D8489F95506C76E4F27CE43D4958810AD")
        testKat(digest(), "4", "2D438E83A3D99929F44A1B0AB5A994EB4ABDFE11F9E72D62DE925BF120CAFCCD")
        testKat(digest(), "5", "8C3C9529C6CC4D266760670F38C7470D6ABA5A0905170A3692AE87E4ABF291FB")
        testKat(digest(), "6", "904573304A5BC7BA040F8DEF9EECA4138F7DDD7DA30E4B8FB97B7F6E06076BED")
        testKat(digest(), "7", "E7195ED9189C0169C90AFFEEFCF8810627DB1607F394FB13C7B43D06C74B1D4B")
        testKat(digest(), "8", "54E7013E72D94B31324D4878F91AE19A7085F20EFE9DAAB96A1FE559C78AE825")
        testKat(digest(), "9", "D4D08F6612F8EB58A855B2F5AABFC504E2972BA829DA94EDD960193D18BAD8D1")
        testKat(digest(), "12", "A7FDB34FD5D85D564A62C0B1B1B60CFA3D7A0C778231C95CDCD9BD293CCA16C6")
        testKat(digest(), "123", "57364D849286C7B3E98F3FC898094F7DC1675BA881A620B75D70F39631A4AA5B")
        testKat(digest(), "1234", "9EBDD24F469993796C4AAC6A821735A65A3CDEF8A359944CE71F34E7A08E1182")
        testKat(digest(), "12345", "B333C8413087FA49882BBD4F76A9223C4AA633A252514852C3F7C0C5F8F4D87B")
        testKat(digest(), "123456", "862B75D2E8E7F08F93812168502AF97BCE530C66688D4372A08EEA0951B5024A")
        testKat(digest(), "1234567", "90B7061A244CE7FBA80F9813787CB90EC3FBB3398AEE740AF1C0D44BC5282B73")
        testKat(digest(), "12345678", "E69E29BA139C20846116D8AD406E6197F1701D8243CC53BB86F2B72C62320A39")
        testKat(digest(), "123456789", "D77629174F56D8451F73CBE80EC7A20EF2DD65C46A1480CD004CBAA96F3FA1FD")
        testKat(digest(), "1234567890", "4F88759143CD9D11F6DE8DA4D3724C36C745223A5CFB7AD0E74DA87C80A43326")
        testKat(digest(), "12345678901", "5FC6C16C29CDD2EF78EE4F3C864C1942A052C110FD5A9711FE9BCF953A2D2D5B")
        testKat(digest(), "123456789012", "15EDA58156CA398AF49CBE9C9E62BF036A66B303ACB0043FB57ECADF9E9C8EDA")
        testKat(
            digest(),
            "1234567890123",
