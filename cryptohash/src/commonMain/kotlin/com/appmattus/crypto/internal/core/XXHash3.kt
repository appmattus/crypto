 ...
 */
@Suppress("KDocUnresolvedReference", "unused", "ClassName", "MemberVisibilityCanBePrivate")
public interface XXH3Family {
    ...
    public fun XXH3_64bits(data: ByteArray, dataOffset: Int, len: size_t): XXH64_hash_t
     ...
     */
    public fun XXH3_64bits_withSeed(data: ByteArray, dataOffset: Int, len: size_t, seed: XXH64_hash_t): XXH64_hash_t
     ...
     */
    public fun XXH3_64bits_withSecret(data: ByteArray, dataOffset: Int, len: size_t, secret: ByteArray, secretSize: size_t): XXH64_hash_t
    ...
    public fun XXH3_createState(): XXH3_state_t
    public fun XXH3_freeState(statePtr: XXH3_state_t): XXH_errorcode
    public fun XXH3_copyState(src_state: XXH3_state_t): XXH3_state_t
     ...
     */
    public fun XXH3_64bits_reset(statePtr: XXH3_state_t): XXH_errorcode
     ...
     */
    public fun XXH3_64bits_reset_withSeed(statePtr: XXH3_state_t, seed: XXH64_hash_t): XXH_errorcode
     ...
     */
    public fun XXH3_64bits_reset_withSecret(statePtr: XXH3_state_t, secret: ByteArray, secretSize: size_t): XXH_errorcode

    public fun XXH3_64bits_update(statePtr: XXH3_state_t, input: ByteArray, inputOffset: Int, length: size_t): XXH_errorcode
    public fun XXH3_64bits_digest(statePtr: XXH3_state_t): XXH64_hash_t
     ...
     * endianness.
     */
    public data class XXH128_hash_t(
     ...
     */
    public fun XXH_versionNumber(): Long
     ...
     */
    public fun XXH3_INITSTATE(XXH3_state_ptr: XXH3_state_t) {
    ...
    public companion object {
         ...
         */
        public const val XXH3_SECRET_SIZE_MIN: Int = 136
         ...
         */
        public const val XXH3_INTERNALBUFFER_SIZE: Int = 256
         ...
         */
        public const val XXH3_SECRET_DEFAULT_SIZE: Int = 192
    }
}
...
public data class XXH3_state_s(
    /** The 8 accumulators */
    val acc: LongArray = LongArray(8),
    /** Used to store a custom secret generated from a seed. */
    val customSecret: ByteArray = ByteArray(XXH3Family.XXH3_SECRET_DEFAULT_SIZE),
    /** The internal buffer. */
...
public enum class XXH_errorcode {
    XXH_OK, XXH_ERROR
}

public typealias XXH32_hash_t = Int
public typealias XXH64_hash_t = Long
public typealias size_t = Int
public typealias xxh_u8 = Byte
public typealias xxh_u32 = Int
public typealias xxh_u64 = Long
...
public class XXH3Impl : XXH3Family {
    ...
    public override fun XXH_versionNumber(): Long {
    ...
    private fun XXH3_scrambleAcc_scalar(acc: LongArray, secret: ByteArray, secretOffset: Int) {
        ...
        val xsecret = secret   /* no alignment restriction */
        for (i in 0 until XXH_ACC_NB) {
            val key64: xxh_u64 = XXH_readLE64(xsecret, secretOffset + 8 * i)
            var acc64: xxh_u64 = xacc[i]
    ...
    private fun XXH3_initCustomSecret_scalar(customSecret: ByteArray, seed64: xxh_u64) {
        ...
        for (i in 0 until nbRounds) {
            //val loR = XXH_readLE64(XXH3_kSecret, 16 * i + 0).toULong()
            //val hiR = XXH_readLE64(XXH3_kSecret, 16 * i + 8).toULong()
    ...
    override fun XXH3_64bits(input: ByteArray, inputOffset: Int, len: size_t): XXH64_hash_t {
        return XXH3_64bits_internal(input, inputOffset, len, 0, XXH3_kSecret, XXH3_kSecret.size, ::XXH3_hashLong_64b_default)
    }

    override fun XXH3_64bits_withSecret(input: ByteArray, inputOffset: Int, len: size_t, secret: ByteArray, secretSize: size_t): XXH64_hash_t {
        return XXH3_64bits_internal(input, inputOffset, len, 0, secret, secretSize, ::XXH3_hashLong_64b_withSecret)
    }

    override fun XXH3_64bits_withSeed(input: ByteArray, inputOffset: Int, len: size_t, seed: XXH64_hash_t): XXH64_hash_t {
        return XXH3_64bits_internal(input, inputOffset, len, seed, XXH3_kSecret, XXH3_kSecret.size, ::XXH3_hashLong_64b_withSeed)
    }

    /* ===   XXH3 streaming   === */

    public override fun XXH3_createState(): XXH3_state_t = XXH3_state_t()

    public override fun XXH3_freeState(statePtr: XXH3_state_t): XXH_errorcode {
        return XXH_errorcode.XXH_OK
    }

    public override fun XXH3_copyState(src_state: XXH3_state_t): XXH3_state_t {
        return XXH3_state_t(
    ...
    override fun XXH3_64bits_reset(statePtr: XXH3_state_t): XXH_errorcode {
        XXH3_reset_internal(statePtr, 0, XXH3_kSecret, XXH_SECRET_DEFAULT_SIZE)
        return XXH_errorcode.XXH_OK
    }

    override fun XXH3_64bits_reset_withSecret(statePtr: XXH3_state_t, secret: ByteArray, secretSize: size_t): XXH_errorcode {
        XXH3_reset_internal(statePtr, 0, secret, secretSize)
        if (secretSize < XXH3_SECRET_SIZE_MIN) return XXH_errorcode.XXH_ERROR
        return XXH_errorcode.XXH_OK
    }

    override fun XXH3_64bits_reset_withSeed(statePtr: XXH3_state_t, seed: XXH64_hash_t): XXH_errorcode {
    ...
    private fun XXH3_update(
        ...
        if (bInput + XXH3_INTERNALBUFFER_SIZE < bEnd) {
            ...
            do {
                println("XXH3_consumeStripes")
                println("  bInput: $bInput")
                println("  nbStripesSoFar: $state.nbStripesSoFar")
                println(state)
    ...
    public override fun XXH3_64bits_update(statePtr: XXH3_state_t, input: ByteArray, inputOffset: Int, length: size_t): XXH_errorcode {
    ...
    override fun XXH3_64bits_digest(state: XXH3_state_t): XXH64_hash_t {
        val secret = state.extSecret ?: state.customSecret
...
public fun toUInt2(u: Long): IntArray {
    return intArrayOf((u and 0xFFFFFFFF).toInt(), (u ushr 32).toInt())
}
